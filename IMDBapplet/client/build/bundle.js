...
/***/ function(module, exports, __webpack_require__) {
	...
	var Widget = __webpack_require__(159);
	
	window.onload = function () {
	  ReactDOM.render(React.createElement(Widget, null), document.getElementById('app'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var sampleData = [{ id: 1, name: "Sausage Party", url: "http://www.google.co.uk" }, { id: 2, name: "Tomato Party", url: "http://www.google.co.uk" }, { id: 3, name: "Potato Party", url: "http://www.google.co.uk" }, { id: 4, name: "Bacon Party", url: "http://www.google.co.uk" }];
	...
	var Widget = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(ShowTimes, { url: this.state.showtimesURL }),
	      React.createElement('hr', null)
	    );
	  }
	...
	var FilmList = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var filmNodes = this.props.data.map(function (film) {
	      return React.createElement(Film, { key: film.id, url: film.url, name: film.name });
	    }.bind(this));
